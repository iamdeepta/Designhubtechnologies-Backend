...
const ServiceSection1Main = () => {
  ...
  function getMainData() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      ...
      axios
        .get(AppUrl.base_url + "servicesection1MainGetSuper")
        .then(function (response) {
          if (response) {
            setMainData(response.data);
  ...
  async function approveMainData(id) {
    let result = await fetch(
      AppUrl.base_url + "servicesection1MainApprove/" + id,
      {
        method: "POST",
      }
    );
  ...
  async function declineMainData(id) {
    let result = await fetch(
      AppUrl.base_url + "servicesection1MainDecline/" + id,
      {
        method: "POST",
      }
    );
                  ...
                  "Login Successful" ? (
                    ...
                    <>
                      <FontAwesomeIcon
                        ...
                        className="home_section_edit"
                        onClick={() =>
                          openApproveModalMain(item.servicesection1_main_id)
                        }
                      />
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          openDeclineModalMain(item.servicesection1_main_id)
                        }
                      />
                    </>
                  )}
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <FontAwesomeIcon
                        ...
                        className="home_section_delete"
                        onClick={() =>
                          closeApproveModalMain(item.servicesection1_main_id)
                        }
                      />
                    </div>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            approveMainData(item.servicesection1_main_id)
                          }
                        >
                          Approve
                        </button>
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <FontAwesomeIcon
                        ...
                        className="home_section_delete"
                        onClick={() =>
                          closeDeclineModalMain(item.servicesection1_main_id)
                        }
                      />
                    </div>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            declineMainData(item.servicesection1_main_id)
                          }
                        >
                          Decline
                        </button>
