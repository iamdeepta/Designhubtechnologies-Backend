...
const HomeSection7Main = () => {
  ...
  function getMainDataFaq() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      ...
      axios
        .get(AppUrl.base_url + "homesection7MainGetSuper")
        .then(function (response) {
          if (response) {
            setMainDataFaq(response.data);
  ...
  async function approveMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "homesection7MainApprove/" + id,
      {
        method: "POST",
      }
    );
  ...
  async function declineMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "homesection7MainDecline/" + id,
      {
        method: "POST",
      }
    );
            ...
            {main_data_faq.map((item, index) => (
              <tr key={item.homesection7_main_id}>
                  ...
                  "Login Successful" ? (
                    ...
                    <>
                      <FontAwesomeIcon
                        ...
                        className="home_section_edit"
                        onClick={() =>
                          openApproveModalMain(item.homesection7_main_id)
                        }
                      />
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          openDeclineModalMain(item.homesection7_main_id)
                        }
                      />
                    </>
                  )}
                ...
                >
                  <div className="card">
                    <div className="card-header">
                      <p>Approve Section 7 FAQ Data</p>
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          closeApproveModalMain(item.homesection7_main_id)
                        }
                      />
                    </div>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            approveMainDataFaq(item.homesection7_main_id)
                          }
                        >
                          Approve
                        </button>
                ...
                >
                  <div className="card">
                    <div className="card-header">
                      <p>Decline Section 7 FAQ Data</p>
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          closeDeclineModalMain(item.homesection7_main_id)
                        }
                      />
                    </div>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            declineMainDataFaq(item.homesection7_main_id)
                          }
                        >
                          Decline
                        </button>
