...
const NewsletterSection = () => {
  ...
  function getData() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      axios
        .get(AppUrl.base_url + "newsletterGet")
  ...
  async function addData() {
    ...
    formData.append("newsletter_message", newsletter_message);
    ...
    let result = await fetch(AppUrl.base_url + "newsletterSend", {
      method: "POST",
      body: formData,
    });
  ...
  async function deleteData(id) {
    let result = await fetch(AppUrl.base_url + "newsletterUserDelete/" + id, {
      method: "POST",
    });
              ...
              <tr key={item.newsletter_id}>
                ...
                <td>
                  ...
                  <FontAwesomeIcon
                    ...
                    onClick={() => openDeleteModal(item.newsletter_id)}
                  />
                  {/* </>
                  ) : (
                    <>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <div className="form-group">
              <textarea
                type="text"
                placeholder="Send message to subscribed users"
                className="form-control"
                rows="15"
