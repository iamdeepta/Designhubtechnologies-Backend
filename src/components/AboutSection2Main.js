...
import AboutSection2MainEdit from "./AboutSection2MainEdit";

const AboutSection2Main = () => {
  ...
  function getMainDataFaq() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      ...
      axios
        .get(AppUrl.base_url + "aboutsection2MainGetSuper")
        .then(function (response) {
          if (response) {
            setMainDataFaq(response.data);
  ...
  async function addMainDataFaq() {
    ...
    let result = await fetch(AppUrl.base_url + "aboutsection2MainAdd", {
      method: "POST",
      body: formData,
    });
  ...
  async function deleteMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "aboutsection2MainDelete/" + id,
      {
        method: "POST",
      }
    );
  ...
  async function approveMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "aboutsection2MainApprove/" + id,
      {
        method: "POST",
      }
    );
  ...
  async function declineMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "aboutsection2MainDecline/" + id,
      {
        method: "POST",
      }
    );
        ...
        <table className="table table-responsive table-striped table-bordered">
          ...
          <tbody>
            {main_data_faq.map((item, index) => (
              <tr key={item.aboutsection2_main_id}>
                <td>{item.aboutsection2_main_title}</td>
                  ...
                  "Login Successful" ? (
                    <>
                      <FontAwesomeIcon
                        ...
                        onClick={() =>
                          openUpdateModalMainFaq(item.aboutsection2_main_id)
                        }
                      />
                      <FontAwesomeIcon
                        icon={faTimes}
                        ...
                        onClick={() =>
                          openDeleteModalMain(item.aboutsection2_main_id)
                        }
                      />
                    </>
                  ) : (
                    <>
                      <FontAwesomeIcon
                        ...
                        className="home_section_edit"
                        onClick={() =>
                          openApproveModalMain(item.aboutsection2_main_id)
                        }
                      />
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          openDeclineModalMain(item.aboutsection2_main_id)
                        }
                      />
                    </>
                  )}
                ...
                <div
                  ...
                  id={
                    ...
                    item.aboutsection2_main_id
                  }
                >
                  <div className="card">
                    <div className="card-header">
                      <p>Update Section 2 List Data</p>
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          closeUpdateModalMainFaq(item.aboutsection2_main_id)
                        }
                      />
                    </div>
                    <AboutSection2MainEdit
                      key={item.aboutsection2_main_id}
                      title_data_faq={item.aboutsection2_main_title}
                      id_data_faq={item.aboutsection2_main_id}
                ...
                >
                  <div className="card">
                    <div className="card-header">
                      <p>Delete Section 2 List Data</p>
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          closeDeleteModalMain(item.aboutsection2_main_id)
                        }
                      />
                    </div>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            deleteMainDataFaq(item.aboutsection2_main_id)
                          }
                        >
                          Delete
                        </button>
                ...
                >
                  <div className="card">
                    <div className="card-header">
                      <p>Approve Section 2 List Data</p>
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          closeApproveModalMain(item.aboutsection2_main_id)
                        }
                      />
                    </div>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            approveMainDataFaq(item.aboutsection2_main_id)
                          }
                        >
                          Approve
                        </button>
                ...
                >
                  <div className="card">
                    <div className="card-header">
                      <p>Decline Section 2 List Data</p>
                      <FontAwesomeIcon
                        icon={faTimes}
                        className="home_section_delete"
                        onClick={() =>
                          closeDeclineModalMain(item.aboutsection2_main_id)
                        }
                      />
                    </div>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            declineMainDataFaq(item.aboutsection2_main_id)
                          }
                        >
                          Decline
                        </button>
                ...
                <div
                  ...
                  id={"modal_blur_bg" + item.aboutsection2_main_id}
                  onClick={() =>
                    closeModalMain(
                      item.aboutsection2_main_id,
                      item.aboutsection2_main_image
                    )
                  }
                ></div>
              </tr>
...
export default AboutSection2Main;
