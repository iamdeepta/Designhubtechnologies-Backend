...
const HomeSection4 = () => {
  ...
  useEffect(() => {
    setTitleUp(data.homesection4_title);
    setDescriptionUp(data.homesection4_description);
    setCategoryUp(data.homesection4_category);
  }, [data]);
  ...
  function getData() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      ...
      axios
        .get(AppUrl.base_url + "homesection4GetSuper")
        .then(function (response) {
          if (response) {
            setData(response.data);
  ...
  async function updateData(id) {
    ...
    let result = await fetch(AppUrl.base_url + "homesection4Update/" + id, {
      method: "POST",
      body: formData,
    });
    ...
    <>
      ...
      <div className="container home_section_div">
        ...
        <table className="table table-responsive table-striped table-bordered">
          ...
          <tbody>
            {data.homesection4_id !== undefined ? (
              <>
                <tr>
                  <td>{data.homesection4_title}</td>
                  <td>{data.homesection4_description}</td>
                  <td>{data.homesection4_category}</td>
                    ...
                    "Login Successful" ? (
                      <>
                        <FontAwesomeIcon
                          ...
                          onClick={() => openUpdateModal(data.homesection4_id)}
                        />
                        <FontAwesomeIcon
                          icon={faTimes}
      ...
      <div
        ...
        id={"home_section_modal_update" + data.homesection4_id}
      >
        <div className="card">
          <div className="card-header">
            <p>Update Section 4 Data</p>
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeUpdateModal(data.homesection4_id)}
            />
          </div>
          <div className="card-body">
            <label>Title:</label>
            ...
            <div className="form-group">
              <button
                ...
                type="button"
                onClick={() => updateData(data.homesection4_id)}
              >
                Update
              </button>
            </div>
