...
const ServiceSection1 = () => {
  ...
  useEffect(() => {
    setTitleUp(data.servicesection1_title);
    setDescriptionUp(data.servicesection1_description);
  }, [data]);
  ...
  function getData() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      ...
      axios
        .get(AppUrl.base_url + "servicesection1GetSuper")
        .then(function (response) {
          if (response) {
            setData(response.data);
  ...
  async function addData() {
    ...
    let result = await fetch(AppUrl.base_url + "servicesection1Add", {
      method: "POST",
      body: formData,
    });
  ...
  async function deleteData(id) {
    let result = await fetch(AppUrl.base_url + "servicesection1Delete/" + id, {
      method: "POST",
    });
  ...
  async function approveData(id) {
    let result = await fetch(AppUrl.base_url + "servicesection1Approve/" + id, {
      method: "POST",
    });
  ...
  async function declineData(id) {
    let result = await fetch(AppUrl.base_url + "servicesection1Decline/" + id, {
      method: "POST",
    });
  ...
  async function updateData(id) {
    ...
    let result = await fetch(AppUrl.base_url + "servicesection1Update/" + id, {
      method: "POST",
      body: formData,
    });
    ...
    <>
      ...
      <div className="container home_section_div">
        ...
        <table className="table table-responsive table-striped table-bordered">
          ...
          <tbody>
            {data.servicesection1_id !== undefined ? (
              <>
                <tr>
                  <td>{data.servicesection1_title}</td>
                  <td>{data.servicesection1_description}</td>
                    ...
                    "Login Successful" ? (
                      <>
                        <FontAwesomeIcon
                          ...
                          onClick={() =>
                            openUpdateModal(data.servicesection1_id)
                          }
                        />
                        <FontAwesomeIcon
                          icon={faTimes}
                          ...
                          onClick={() =>
                            openDeleteModal(data.servicesection1_id)
                          }
                        />
                      </>
                    ) : (
                      <>
                        <FontAwesomeIcon
                          ...
                          className="home_section_edit"
                          onClick={() =>
                            openApproveModal(data.servicesection1_id)
                          }
                        />
                        <FontAwesomeIcon
                          icon={faTimes}
                          className="home_section_delete"
                          onClick={() =>
                            openDeclineModal(data.servicesection1_id)
                          }
                        />
                      </>
                    )}
        ...
        <div className="card">
          <div className="card-header">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeModal(data.servicesection1_id)}
            />
          </div>
      ...
      <div
        ...
        id={"home_section_modal_update" + data.servicesection1_id}
      >
        <div className="card">
          <div className="card-header">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeUpdateModal(data.servicesection1_id)}
            />
          </div>
          <div className="card-body">
            <label>Title:</label>
            ...
            <div className="form-group">
              <button
                ...
                type="button"
                onClick={() => updateData(data.servicesection1_id)}
              >
                Update
              </button>
            </div>
      ...
      <div
        ...
        id={"home_section_modal_delete" + data.servicesection1_id}
      >
        <div className="card">
          <div className="card-header">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeDeleteModal(data.servicesection1_id)}
            />
          </div>
          <div className="card-body">
            ...
            <div className="form-group">
              <button
                ...
                type="button"
                onClick={() => deleteData(data.servicesection1_id)}
              >
                Delete
              </button>
            </div>
      ...
      <div
        className="home_section_modal_delete inactive_home_section_modal_delete"
        id={"home_section_modal_approve" + data.servicesection1_id}
      >
        <div className="card">
          <div className="card-header">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeApproveModal(data.servicesection1_id)}
            />
          </div>
          <div className="card-body">
            ...
            <div className="form-group">
              <button
                className="btn btn-success form-control"
                type="button"
                onClick={() => approveData(data.servicesection1_id)}
              >
                Approve
              </button>
            </div>
      ...
      <div
        className="home_section_modal_delete inactive_home_section_modal_delete"
        id={"home_section_modal_decline" + data.servicesection1_id}
      >
        <div className="card">
          <div className="card-header">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeDeclineModal(data.servicesection1_id)}
            />
          </div>
          <div className="card-body">
            ...
            <div className="form-group">
              <button
                className="btn btn-danger form-control"
                type="button"
                onClick={() => declineData(data.servicesection1_id)}
              >
                Decline
              </button>
            </div>
