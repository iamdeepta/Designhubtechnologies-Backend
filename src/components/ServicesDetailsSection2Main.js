...
import ServicesDetailsSection2MainEdit from "./ServicesDetailsSection2MainEdit";

const ServicesDetailsSection2Main = () => {
  ...
  function getMainDataFaq() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      ...
      axios
        .get(AppUrl.base_url + "servicesdetailssection2MainGetSuper")
        .then(function (response) {
          if (response) {
            setMainDataFaq(response.data);
  ...
  async function addMainDataFaq() {
    ...
    let result = await fetch(
      AppUrl.base_url + "servicesdetailssection2MainAdd",
      {
        method: "POST",
        body: formData,
      }
  ...
  async function deleteMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "servicesdetailssection2MainDelete/" + id,
      {
        method: "POST",
      }
    );
  ...
  async function approveMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "servicesdetailssection2MainApprove/" + id,
      {
        method: "POST",
      }
    );
  ...
  async function declineMainDataFaq(id) {
    let result = await fetch(
      AppUrl.base_url + "servicesdetailssection2MainDecline/" + id,
      {
        method: "POST",
      }
    );
        ...
        <table className="table table-responsive table-striped table-bordered">
          ...
          <tbody>
            {main_data_faq.map((item, index) => (
              <tr key={item.servicesdetailssection2_main_id}>
                <td>{item.servicesdetailssection2_main_title}</td>
                  ...
                  "Login Successful" ? (
                    <>
                      <FontAwesomeIcon
                        ...
                        onClick={() =>
                          openUpdateModalMainFaq(
                            item.servicesdetailssection2_main_id
                          )
                        }
                      />
                      <FontAwesomeIcon
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <FontAwesomeIcon
                        ...
                        className="home_section_delete"
                        onClick={() =>
                          closeUpdateModalMainFaq(
                            item.servicesdetailssection2_main_id
                          )
                        }
                      />
                    </div>
                    <ServicesDetailsSection2MainEdit
                      key={item.servicesdetailssection2_main_id}
                      title_data_faq={item.servicesdetailssection2_main_title}
                      id_data_faq={item.servicesdetailssection2_main_id}
                ...
                <div
                  ...
                  id={"modal_blur_bg" + item.servicesdetailssection2_main_id}
                  onClick={() =>
                    closeModalMain(
                      item.servicesdetailssection2_main_id,
                      item.servicesdetailssection2_main_image
                    )
                  }
                ></div>
              </tr>
...
export default ServicesDetailsSection2Main;
