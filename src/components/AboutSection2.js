...
const AboutSection2 = () => {
  ...
  function getData() {
    if (JSON.parse(localStorage.getItem("admin-info")) === "Login Successful") {
      ...
      axios
        .get(AppUrl.base_url + "aboutsection2GetSuper")
        .then(function (response) {
          if (response) {
            setData(response.data);
  ...
  async function approveData(id) {
    let result = await fetch(AppUrl.base_url + "aboutsection2Approve/" + id, {
      method: "POST",
    });
  ...
  async function declineData(id) {
    let result = await fetch(AppUrl.base_url + "aboutsection2Decline/" + id, {
      method: "POST",
    });
  ...
  return (
    <>
                    ...
                    "Login Successful" ? (
                      ...
                      <>
                        <FontAwesomeIcon
                          ...
                          className="home_section_edit"
                          onClick={() =>
                            openApproveModal(data.aboutsection2_id)
                          }
                        />
                        <FontAwesomeIcon
                          icon={faTimes}
                          className="home_section_delete"
                          onClick={() =>
                            openDeclineModal(data.aboutsection2_id)
                          }
                        />
                      </>
                    )}
      ...
      <div
        className="home_section_modal_delete inactive_home_section_modal_delete"
        id={"home_section_modal_approve" + data.aboutsection2_id}
      >
        <div className="card">
          <div className="card-header">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeApproveModal(data.aboutsection2_id)}
            />
          </div>
          <div className="card-body">
            ...
            <div className="form-group">
              <button
                className="btn btn-success form-control"
                type="button"
                onClick={() => approveData(data.aboutsection2_id)}
              >
                Approve
              </button>
            </div>
      ...
      <div
        className="home_section_modal_delete inactive_home_section_modal_delete"
        id={"home_section_modal_decline" + data.aboutsection2_id}
      >
        <div className="card">
          <div className="card-header">
            ...
            <FontAwesomeIcon
              icon={faTimes}
              className="home_section_delete"
              onClick={() => closeDeclineModal(data.aboutsection2_id)}
            />
          </div>
          <div className="card-body">
            ...
            <div className="form-group">
              <button
                className="btn btn-danger form-control"
                type="button"
                onClick={() => declineData(data.aboutsection2_id)}
              >
                Decline
              </button>
            </div>
